...
public class AiRandomPlayer implements AiGeneral{
	...
	public Object[] aiTurn() {
		if(ai.getActiveState()==true) {
			...
			// Moves normally
        		...
        		if(completelyBlocked==true || player.didPlayerLose()) {
        			Object[] arr = {1,oldPosition,aiPieces[random].getPosition(),false,null,true};
        			return arr;
        		}
        		if(ai.checkForMill(aiPieces[random])==true) {
        			Object[] whatHappend = removeAfterMill();
        			if((boolean) whatHappend[1]==true) {
        				Object[] arr = {1,oldPosition,aiPieces[random].getPosition(),true,whatHappend[0],true};
        				return arr;
        			}
        			else {
        				Object[] arr = {1,oldPosition,aiPieces[random].getPosition(),true,whatHappend[0],false};
        				return arr;
        			}
        		}
        		else {
        			Object[] arr = {1,oldPosition,aiPieces[random].getPosition(),false,null,false};
        			return arr;
        		}
			}
			...
			// Has to jump
        		...
        		if(completelyBlocked==true || player.didPlayerLose()) {
        			Object[] arr = {2,oldPosition,aiPieces[random].getPosition(),false,null,true};
        			return arr;
        		}
        		if(ai.checkForMill(aiPieces[random])==true) {
        			Object[] whatHappend = removeAfterMill();
        			if((boolean) whatHappend[1]==true) {
        				Object[] arr = {2,oldPosition,aiPieces[random].getPosition(),true,whatHappend[0],true};
        				return arr;
        			}
        			else {
        				Object[] arr = {2,oldPosition,aiPieces[random].getPosition(),true,whatHappend[0],false};
        				return arr;
        			}
        		}
        		else {
        			Object[] arr = {2,oldPosition,aiPieces[random].getPosition(),false,null,false};
        			return arr;
        		}
			}
		}
